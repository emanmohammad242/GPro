...
import com.example.farhaapplication.Adapters.Adapter_Category;
...
public class Category_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.catego);
    ...
    private class DownloadTextTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Adapter_Category adapter = new Adapter_Category(Category_Activity.this, categoryList);
    ...
    public void insert_btn_OnClick(View view){
        Intent intent = new Intent(this,AddCategory_Activity.class);
